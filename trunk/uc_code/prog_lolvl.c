...
{
/*
 * main difference enter_ISCP_PIC24 and enter_ISCP_PIC24E is PIC24E256MC202 (tested) requires 3 nops (per doc DS70633)
 * but the PIC24FJ64B002 (tested) will only work with 1 nop before the goto 0x200.
 * there are some other minor timing differences as well
 */
    enablePGC_D(); //PGC/D output & PGC/D_LOW appropriate
